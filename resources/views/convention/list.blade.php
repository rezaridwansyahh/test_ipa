                  ...
                  <section class="search-filters">
                    <div class="container">
                        <div class="filter-box">
                            ...
                            <div class="col-md-9" id="daftar_buku">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-body">
                                                <a href="/convention/{{ $jurnal['id'] }}"><h5 class="black">{{ str_limit($jurnal['title'],65,'...') }}</h5></a>
