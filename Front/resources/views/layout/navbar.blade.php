                        ...
                        <div class="navbar-collapse hidden-sm hidden-xs">
                            <ul class="nav navbar-nav">
                                <li class="dropdown active">
                                    <a data-toggle="dropdown" class="dropdown-toggle disabled" href="index.html">Abouts</a>
                                ...
                                <li class="dropdown">
                                    <a data-toggle="dropdown" class="dropdown-toggle disabled" href="books-media-list-view.html">The Industry</a>
                                    <ul class="dropdown-menu">
                                ...
                                <li class="dropdown">
                                    <a data-toggle="dropdown" class="dropdown-toggle disabled" href="blog.html">News</a>
                                    <ul class="dropdown-menu">
                                ...
                                <li><a href="contact.html">2017 IPA CONFEX</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
